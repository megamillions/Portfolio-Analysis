...
inv_approx_value = 25.5
ira_approx_value = 101
...
# Break into 30 units for sale.
inv_unit = (inv_approx_value / 30) * 0.5177 # Brings closer to $20 individual.
ira_unit = (ira_approx_value / 30) * 0.1634 # Brings closer to $40 ind'l.
...
inv_buy_unit = inv_unit * 0.3334
ira_buy_unit = ira_unit * 0.2
