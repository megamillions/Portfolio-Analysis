...
# Break into 30 units.
inv_unit = (inv_approx_value / 30) * 0.3575 # Brings closer to $20 individual.
ira_unit = (ira_approx_value / 30) * 0.0323 # Brings closer to $100 ind'l.
